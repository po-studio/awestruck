...
class AwestruckInfrastructure extends TerraformStack {
  constructor(scope: Construct, id: string) {
    ...
    const ecsTaskExecutionRole = new IamRole(this, "ecs-task-execution-role", {
      ...
      managedPolicies: [
        IamRolePolicyAttachment.fromManagedPolicyName(this, "service-role/AmazonECSTaskExecutionRolePolicy"),
        IamRolePolicyAttachment.fromManagedPolicyName(this, "CloudWatchLogsFullAccess"),
      ],
    });
